...
gbm_model_loaded = pickle.load(open(modelPath + '2023_gbm_model.pkl', "rb"))
xgb_model_loaded = pickle.load(open(modelPath + 'xgb_model_22.pkl', "rb"))
gmodel = load_learner(modelPath + '/5')
...
cm_nn = ClassificationInterpretation.from_learner(gmodel,dl=dl)

# Soft Voting (Ensemble)
avgs = (nn_preds + xgb_preds + gbm_preds) / 3
